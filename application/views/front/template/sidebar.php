        ...
        <div class="col-md-2">
          <div class="list-group" style="margin-bottom:7%">
            ...
            <?php endforeach; ?>
            <a href="<?php echo base_url('Front/about'); ?>" class="list-group-item list-group-item-action <?php if($value['media_type_id']==$this->uri->segment(3)){ echo 'about'; } ?>">เกี่ยวกับเรา</a>
