<div class="page-breadcrumb">
   <div class="row">
       <div class="col-12 d-flex no-block align-items-center">
           <h4 class="page-title">แก้ข่าวสาร</h4>
                   ...
                   <div class="row">
                     <div class="col-lg-12">
                       <div class="card">
                           ...
                           <?php echo form_open_multipart('News/news_edit'); ?>
                             <div class="card-body">
                                 <div class="form-group row">
                                     <label class="col-sm-3 text-right control-label col-form-label">หัวข้อข่าว</label>
                                     <div class="col-sm-9">
                                         <input type="text" name="news_title" class="form-control" value="<?php echo $news_edit[0]['news_title'] ?>" required>
                                     </div>
                                 </div>
                                 <div class="form-group row">
                                     <label class="col-sm-3 text-right control-label col-form-label">รายละเอียดข่าว</label>
                                     <div class="col-sm-9">
                                         <textarea name="news_detail" id="news_detail" rows="10" cols="80"><?php echo $news_edit[0]['news_detail'] ?></textarea>
                                         <script>
