                          ...
                          <div class="el-card-avatar el-overlay-1">
                            ...
                            <div class="el-overlay">
                              <ul class="list-style-none el-info">
                                ...
                                <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?php echo base_url('Media/mediaDelete/'.$value['media_type_id'].'/'.$value['media_id']);  ?>"><i class="fas fa-trash-alt"></i></a></li>
                          ...
                          <?php if ($value['media_type_id']==3): ?>
                            <video width="100%" controls>
                              ...
                              <source src="<?php echo base_url('assets/uploads/'.$value['media_type_folder'].'/'.$value['media_link']);  ?>" type="video/mp4">
                                ...
                                <a class="btn btn-danger" href="JavaScript:if(confirm('ยืนยันการลบ?') == true){window.location='<?php echo site_url('Media/mediaDelete/'.$value['media_type_id'].'/'.$value['media_id']); ?>';}">ลบ</a>
